...
public:
	...
	limiting_source (const limiting_source &) = default;
	limiting_source (limiting_source &&) = default;
	limiting_source & operator = (const limiting_source &) = default;
	...
	/**
	 *	Determines the number of characters which may be
	 *	read before the limit is reached.
	 *
	 *	\return
